...
<p align="center">
  <img src="docs/screenshots/panel-list.png" width="560" alt="Agent Dock のフローティングパネル。ピン留め・要対応・実行中のセッションと、折りたたまれた停滞中セクションを表示している">
</p>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="docs/screenshots/panel-grid.png" width="360" alt="グリッド表示。アイコンとタイトルのみ"><br>
      <sub>グリッド表示(アイコン+タイトルのみ)</sub>
    </td>
    <td align="center" width="50%">
      <img src="docs/screenshots/menu-bar.png" width="360" alt="標準のメニューバードロップダウン。状態ごとにグループ化されている"><br>
      <sub>メニューバーのドロップダウン</sub>
    </td>
  </tr>
</table>
